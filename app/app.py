...
partner = c1.selectbox("Partner", ["No", "Yes"])
...
if "MultipleLines_Yes" in input_data:
    input_data["MultipleLines_Yes"] = 1 if multiple == "Yes" else 0
...
if "OnlineSecurity_Yes" in input_data:
    input_data["OnlineSecurity_Yes"] = 1 if security == "Yes" else 0
...
if "OnlineBackup_Yes" in input_data:
    input_data["OnlineBackup_Yes"] = 1 if backup == "Yes" else 0
...
if "DeviceProtection_Yes" in input_data:
    input_data["DeviceProtection_Yes"] = 1 if device == "Yes" else 0
...
if "TechSupport_Yes" in input_data:
    input_data["TechSupport_Yes"] = 1 if support == "Yes" else 0
...
if "StreamingTV_Yes" in input_data:
    input_data["StreamingTV_Yes"] = 1 if tv == "Yes" else 0
...
if "StreamingMovies_Yes" in input_data:
    input_data["StreamingMovies_Yes"] = 1 if movies == "Yes" else 0
